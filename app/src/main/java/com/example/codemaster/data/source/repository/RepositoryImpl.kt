...
class RepositoryImpl @Inject constructor(
    ...
    override suspend fun signupUser(name: String, email: String, password: String): Flow<Response<AuthResult>> {
        return flow {
            emit(Response.Loading())
    ...
    override suspend fun saveCodechefUser(username: String?): Flow<Response<String>> = callbackFlow {
    ...
    override suspend fun saveCodeforcesUser(username: String?): Flow<Response<String>> = callbackFlow {
        trySend(Response.Loading())
    ...
    override suspend fun saveLeetcodeUser(username: String?): Flow<Response<String>> = callbackFlow {
        trySend(Response.Loading())
    ...
    override fun getCodechefUser(): Flow<String?> = callbackFlow {
        val valueEvent = object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                val codechefUser = snapshot.child(firebaseAuth.currentUser?.uid.toString()).child("codechef").value.toString()
    ...
    override fun getCodeforcesUser(): Flow<String?> = callbackFlow {
        val valueEvent = object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                val codeforcesUser = snapshot.child(firebaseAuth.currentUser?.uid.toString()).child("codeforces").value.toString()
    ...
    override fun getLeetcodeUser(): Flow<String?> = callbackFlow {
        val valueEvent = object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                val leetcodeUser = snapshot.child(firebaseAuth.currentUser?.uid.toString()).child("leetcode").value.toString()
